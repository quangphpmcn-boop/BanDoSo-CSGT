...
const DEFAULT_HQ_LOCATIONS = [
  ...
  { group: 'Trụ sở Đội Văn Phòng', name: 'Số 14 Phan Chu Trinh, phường Hồng Bàng, TP Hải Phòng', lat: 20.858639, lng: 106.682833 },
  { group: 'Trụ sở Đội Văn Phòng', name: 'Số 106A Nguyễn Lương Bằng, Thành Đông, TP Hải Phòng', lat: 20.938167, lng: 106.316861 },
  { group: 'Trụ sở Đội Văn Phòng', name: 'Km 57+600 Quốc lộ 5, phường Ái Quốc, TP Hải Phòng', lat: 20.959194, lng: 106.368056 },
  { group: 'Trụ sở Đội Văn Phòng', name: 'Số 119 Hùng Vương, phường Hồng Bàng, TP Hải Phòng', lat: 20.868806, lng: 106.655861 },

  // ── Trụ sở Đội, Trạm CSGT đường bộ ──
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 41 Tam Bạc, phường Hồng Bàng, TP Hải Phòng', lat: 20.857306, lng: 106.674167 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 257 Hai Bà Trưng, phường Lê Chân, TP Hải Phòng', lat: 20.851583, lng: 106.673667 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Ngõ 258 Đà Nẵng, Ngô Quyền, Hải Phòng', lat: 20.857278, lng: 106.706444 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 281 Lạch Tray, TP Hải Phòng', lat: 20.831333, lng: 106.698778 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 202 đường Đa Phúc, TDP Quảng Luận, phường Hưng Đạo, TP Hải Phòng', lat: 20.798389, lng: 106.658528 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 263 Nguyễn Hữu Cầu, phường Đồ Sơn, TP Hải Phòng', lat: 20.723417, lng: 106.776472 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Khu Tắc Giang, xã Kiến Minh, TP Hải Phòng', lat: 20.755194, lng: 106.675944 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 160, Đường 354, khu 3, xã Tiên Lãng', lat: 20.728639, lng: 106.558333 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 541 Hùng Vương, phường Hồng Bàng, TP Hải Phòng', lat: 20.889694, lng: 106.604083 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: '28 Ký Con, Hồng Bàng, HP', lat: 20.855639, lng: 106.674306 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 5 Mạc Thái Tổ, Đông Hải, TP Hải Phòng', lat: 20.842556, lng: 106.755778 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Thôn Bến, đặc khu Cát Hải, TP Hải Phòng', lat: 20.753028, lng: 107.013583 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Km 58+900 Quốc lộ 5, phường Ái Quốc, TP Hải Phòng', lat: 20.967028, lng: 106.377028 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 25 Đại lộ Hồ Chí Minh, phường Thành Đông, TP Hải Phòng', lat: 20.938917, lng: 106.327139 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 25 đường Phượng Hoàng, phường Trần Hưng Đạo, TP Hải Phòng', lat: 21.118944, lng: 106.392583 },
  ...
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Km 35+350 Quốc lộ 10, xã An Quang, TP Hải Phòng', lat: 20.688222, lng: 106.479972 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 21 đường 20/8, xã Vĩnh Bảo, TP Hải Phòng', lat: 20.688212, lng: 106.479981 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 2 đường Ngô Quyền, xã An Lão, TP Hải Phòng', lat: 20.821194, lng: 106.556250 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Km 9+400 Quốc lộ 10, TP Hải Phòng', lat: 20.983444, lng: 106.672361 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 78 đường 25/10, TP Hải Phòng', lat: 20.918000, lng: 106.673222 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Km83+220 Quốc lộ 5, Phường Hồng An, TP Hải Phòng', lat: 20.905472, lng: 106.575250 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 6 đường 351, huyện An Dương, TP Hải Phòng', lat: 20.864944, lng: 106.613917 },
  { group: 'Trụ sở Đội/Trạm CSGT đường bộ', name: 'Số 702 Trần Nhân Tông, phường Kiến An, TP Hải Phòng', lat: 20.808806, lng: 106.640278 },

  // ── Trụ sở Đội, Trạm CSĐT ──
  { group: 'Trụ sở Đội/Trạm CSĐT', name: 'Số 41 Tam Bạc, phường Hồng Bàng, TP Hải Phòng', lat: 20.857306, lng: 106.674167 },
  { group: 'Trụ sở Đội/Trạm CSĐT', name: 'Bến đò nhà đèn, Đông Hải, TP Hải Phòng', lat: 20.846417, lng: 106.761528 },
  { group: 'Trụ sở Đội/Trạm CSĐT', name: 'Bờ trái sông Cấm, gần bến phà Máy Chai, phường Ngô Quyền, TP Hải Phòng', lat: 20.875472, lng: 106.705333 },
  { group: 'Trụ sở Đội/Trạm CSĐT', name: 'Số 592, Hùng Vương, phường Hồng Bàng, TP Hải Phòng', lat: 20.879472, lng: 106.629833 },
  { group: 'Trụ sở Đội/Trạm CSĐT', name: 'Tân Thắng, xã An Hưng, TP Hải Phòng', lat: 20.763500, lng: 106.549917 },
  { group: 'Trụ sở Đội/Trạm CSĐT', name: 'Số 106A Nguyễn Lương Bằng, Thành Đông, TP Hải Phòng', lat: 20.938167, lng: 106.316861 },
  { group: 'Trụ sở Đội/Trạm CSĐT', name: 'Thôn Hạ Vĩnh, xã Hà Đông, TP Hải Phòng', lat: 20.846889, lng: 106.486306 },
  { group: 'Trụ sở Đội/Trạm CSĐT', name: 'KDC Vạn Chánh, phường Nhị Chiểu, TP Hải Phòng', lat: 21.013611, lng: 106.546083 },
  { group: 'Trụ sở Đội/Trạm CSĐT', name: 'Tổ dân phố 4, Nam Triệu, TP Hải Phòng', lat: 20.937500, lng: 106.764778 },
  { group: 'Trụ sở Đội/Trạm CSĐT', name: 'Số 1 Chương Dương, phường Hồng Bàng, TP Hải Phòng', lat: 20.864667, lng: 106.670083 },
  { group: 'Trụ sở Đội/Trạm CSĐT', name: 'Lán Bè, An Biên, TP Hải Phòng', lat: 20.844528, lng: 106.658778 }
];
